...
var intuneSection = builder.Configuration.GetSection("IntuneDeployment");
var intuneOptions = intuneSection.Get<IntuneDeploymentOptions>() ?? new IntuneDeploymentOptions();
builder.Services.AddSingleton(intuneOptions);
...
builder.Services.AddScoped<IntuneDeploymentService>();
